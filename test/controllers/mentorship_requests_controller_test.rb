...
class MentorshipRequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mentorship_request" do
    assert_difference("MentorshipRequest.count") do
      post mentorship_requests_url, params: { mentorship_request: { goals: @mentorship_request.goals, mentee_id: @mentorship_request.mentee_id, mentor_id: @mentorship_request.mentor_id, preferred_times: @mentorship_request.preferred_times, status: @mentorship_request.status, topic: @mentorship_request.topic } }
    end
  ...
  test "should update mentorship_request" do
    patch mentorship_request_url(@mentorship_request), params: { mentorship_request: { goals: @mentorship_request.goals, mentee_id: @mentorship_request.mentee_id, mentor_id: @mentorship_request.mentor_id, preferred_times: @mentorship_request.preferred_times, status: @mentorship_request.status, topic: @mentorship_request.topic } }
